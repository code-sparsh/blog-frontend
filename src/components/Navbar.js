        ...
        <nav class=" bg-slate-300 border-gray-200 shadow px-2 sm:px-4 py-2.5 rounded light:bg-gray-900">
            <div class="container flex flex-wrap items-center justify-between mx-auto">
                <Link to="/" class="flex items-center">
                    ...
                    <img src={blogIcon} class=" h-11 mr-3" alt="Flowbite Logo" />
                    <span class="self-center text-2xl m-2 font-semibold whitespace-nowrap light:text-white">BlogPoint</span>
                </Link>
                <div class="flex items-center md:order-2">
                    ...
                    <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow light:bg-gray-700 light:divide-gray-600" id="user-dropdown">
                        ...
                        <ul class="py-2" aria-labelledby="user-menu-button">
                            <li>
                                <Link to="/profile/form" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 light:hover:bg-gray-600 light:text-gray-200 light:hover:text-white">Update Profile</Link>
                            </li>
                            <li>
                                <Link to="/mylistings" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 light:hover:bg-gray-600 light:text-gray-200 light:hover:text-white">My Orders</Link>
                            </li>
                            <li>
